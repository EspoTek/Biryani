function [outputMatrix] = b7a_get_data_all_channels_recent(sampleRate_hz, filter_mode, delay_seconds, timeWindow_seconds)
    ...
    outputMatrix = shared_lib_call_biryani_getData_allChannels_recent(sampleRate_hz, filter_mode, delay_seconds, timeWindow_seconds);